...
//   useEffect(() => {
//     fetchData();
//     // Removed 'clearAllData()' from useEffect to prevent clearing data on component load
//   }, [timeRange]);
...
//         setLoading(false);
//         return; // Early return to prevent fetching new data
//       }

//       // Fetch new data because cached data is stale or invalid
